...
function EditOutletProduct({
      ...
      try {
        ...
        if (Array.isArray(rawGroups) && rawGroups.length > 0) {
          ...
          rawGroups.forEach((g) => {
            ...
            const rawOpts =
              g.options ||
              g.productVariantOptions ||
              g.values ||
              g.variantGroupValues ||
              [];
              ...
              rawOpts.forEach((opt) => {
                const optId =
                  opt.productVariantOptionsId !== undefined && opt.productVariantOptionsId !== null
                    ...
                    : opt.variantOptionId !== undefined && opt.variantOptionId !== null
                    ? Number(opt.variantOptionId)
                    : null;
                const valId =
                  opt.productVariantGroupValuesId !== undefined && opt.productVariantGroupValuesId !== null
                    ? Number(opt.productVariantGroupValuesId)
                    : opt.variantGroupValueId !== undefined && opt.variantGroupValueId !== null
                    ? Number(opt.variantGroupValueId)
                    : null;
                const vName = (
                  opt.variantName ||
                  opt.optionName ||
  ...
  const handleSave = async () => {
    ...
    const enabledDays = Object.entries(daySpecificTimings).filter(([, t]) => t.enabled);
