...
function CreateSubscriptionPlan() {
  ...
  return (
    <div className="create-sub-page-wrapper">
      <h2 className="create-sub-page-title">Create Subscription Plan</h2>
      ...
      <div className="create-sub-card">
        <div className="create-sub-card-header">CREATE SUBSCRIPTION PLAN</div>
        ...
        <div className="create-sub-form-grid">
          ...
          <div className="create-sub-form-group">
            <label className="create-sub-form-label">Radius (KM)</label>
            <input
              className="create-sub-form-input"
              type="number"
              name="radiusInKms"
        ...
        <div className="create-sub-button-wrapper">
          <button
            className="create-sub-update-btn"
            onClick={handleSave}
            disabled={loading}
          >
